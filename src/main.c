...
int main(int argc, char **argv) {
    ...
    /* Initialize storage for test results & parse input arguments. */
    init(argc, argv);
...
void wul() {
    ...
    if (arr_a == NULL || arr_b == NULL) {
        fprintf(stderr, "Unable to allocate memory in wul().\n");
    }
