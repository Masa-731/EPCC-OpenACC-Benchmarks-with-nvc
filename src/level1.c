...
double twodconv()
{
    ...
    { // 0
        for (j = 1; j < n - 1; j++)
        { // 1
            B[i * n + j] = c11 * A[(i - 1) * n + (j - 1)] + c12 * A[i * n + (j - 1)] + c13 * A[(i + 1) * n + (j - 1)] + c21 * A[(i - 1) * n + j] + c22 * A[i * n + j] + c23 * A[(i + 1) * n + j] + c31 * A[(i - 1) * n + (j + 1)] + c32 * A[i * n + (j + 1)] + c33 * A[(i + 1) * n + (j + 1)];
        }
    }
...
double threedconv()
{
    ...
    { /* 0 */
        ...
        { /* 1 */
            for (k = 1; k < n - 1; k++)
            { /* 2 */
                B[i * n * n + j * n + k] = 0 + c11 * A[(i - 1) * n * n + (j - 1) * n + (k - 1)] + c13 * A[(i + 1) * n * n + (j - 1) * n + (k - 1)]
                                             + c21 * A[(i - 1) * n * n + (j - 1) * n + (k - 1)] + c23 * A[(i + 1) * n * n + (j - 1) * n + (k - 1)]
                                             + c31 * A[(i - 1) * n * n + (j - 1) * n + (k - 1)] + c33 * A[(i + 1) * n * n + (j - 1) * n + (k - 1)]
                                             + c12 * A[(i + 0) * n * n + (j - 1) * n + (k + 0)] + c22 * A[(i + 0) * n * n + (j + 0) * n + (k + 0)] + c32 * A[(i + 0) * n * n + (j + 1) * n + (k + 0)]
...
#pragma acc loop independent
        ...
        { /* 0 */
            ...
            { /* 1 */
                for (k = 1; k < n - 1; k++)
                { /* 2 */
                    B_Gpu[i * n * n + j * n + k] = 0 + c11 * A[(i - 1) * n * n + (j - 1) * n + (k - 1)] + c13 * A[(i + 1) * n * n + (j - 1) * n + (k - 1)]
                                                     + c21 * A[(i - 1) * n * n + (j - 1) * n + (k - 1)] + c23 * A[(i + 1) * n * n + (j - 1) * n + (k - 1)]
                                                     + c31 * A[(i - 1) * n * n + (j - 1) * n + (k - 1)] + c33 * A[(i + 1) * n * n + (j - 1) * n + (k - 1)]
                                                     + c12 * A[(i + 0) * n * n + (j - 1) * n + (k + 0)] + c22 * A[(i + 0) * n * n + (j + 0) * n + (k + 0)] + c32 * A[(i + 0) * n * n + (j + 1) * n + (k + 0)]
                                                     + c11 * A[(i - 1) * n * n + (j - 1) * n + (k + 1)] + c13 * A[(i + 1) * n * n + (j - 1) * n + (k + 1)]
